...
// I've modified this slightly to add vertex normals so the brain
// looks less polygonal-y
...
THREE.OBJLoader.prototype = {
	...
	for ( var i = 0, l = children.length; i < l; i ++ ) {
	    ...
	    var geom = children[ i ].geometry;

	    geom.computeFaceNormals();
	    geom.computeVertexNormals(); //Makes this look a little better.
